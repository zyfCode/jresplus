...
//		equity_investment.queryProfit(type);
	...
	} else if (type == "gqhg" || type == "gqcr" || type == "jchg" || type == "jccr"|| type == "wqhg"||type == "zqhg" || type == "zqcr"||type == "ckhg" || type == "ckcr"|| type == "zczc") {
...
var profit = {
		...
		showMonenyWin : function(element) {
			var h_profit_type = common_operate.checkProfitType(element),
				obj = {},
				grid = window.parent.Horn.getComp("dataTable").getSelecteds();
