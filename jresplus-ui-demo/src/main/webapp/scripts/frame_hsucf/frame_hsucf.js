	...
	function initMenuItem(target){
		...
		Horn.Frame.menu.menus[menuId]={
				...
				resize:function(){
					...
					this.scroll.css({height:scrollHeight});
					
					if(bodyHeight<contentHeight){
						this.scroll.show();
						var scrollRate=scrollHeight/contentHeight;
						this.scrollBar.css({
							height:scrollRate*scrollHeight,
		...
		Horn.Frame.screen={
				...
				create:function(conf){
					if(Horn.Frame.screen.isLimit()){
						...
						tabHtml+="<div><span>"+conf.title+"</span><span class=\"h-tab-close\"></span></div></li>";
						var tab=$(tabHtml);
